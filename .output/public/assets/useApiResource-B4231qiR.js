...
import { d as t, f as n, s as r } from "./auth-CRzH69JE.js";
import {
  a as i,
  c as a,
  d as o,
...
var b = class extends c {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      S(this.#t, this.options) ? this.#h() : this.updateResult(),
      this.#y());
  }
  onUnsubscribe() {
  ...
  shouldFetchOnReconnect() {
    return C(this.#t, this.options, this.options.refetchOnReconnect);
  }
  ...
  setOptions(e) {
    ...
    (r && w(this.#t, n, this.options, t) && this.#h(),
      this.updateResult(),
      r &&
        (this.#t !== n ||
          d(this.options.enabled, this.#t) !== d(t.enabled, this.#t) ||
          y(this.options.staleTime, this.#t) !== y(t.staleTime, this.#t)) &&
        this.#g());
    let i = this.#_();
    r &&
      (this.#t !== n ||
  ...
  #g() {
    ...
    if (i.isServer() || this.#r.isStale || !m(e)) return;
  ...
  #v(e) {
    (this.#x(),
      ...
      !(
        ...
        (this.#f = f.setInterval(() => {
          (this.options.refetchIntervalInBackground || l.isFocused()) &&
            this.#h();
        }, this.#p)));
  }
  #y() {
  ...
  #b() {
    this.#d !== void 0 && (f.clearTimeout(this.#d), (this.#d = void 0));
  }
  #x() {
    this.#f !== void 0 && (f.clearInterval(this.#f), (this.#f = void 0));
  }
  createResult(e, t) {
    let n = this.#t,
      r = this.options,
    ...
    if (t._optimisticResults) {
      let i = this.hasListeners(),
        a = !i && S(e, t),
        o = i && w(e, n, t, r);
      ((a || o) && (f = { ...f, ...p(l.data, e.options) }),
        t._optimisticResults === `isRestoring` && (f.fetchStatus = `idle`));
    }
    let { error: g, errorUpdatedAt: _, status: v } = f;
    h = f.data;
    let y = !1;
    if (t.placeholderData !== void 0 && h === void 0 && v === `pending`) {
      let e;
      (i?.isPlaceholderData && t.placeholderData === s?.placeholderData
        ? ((e = i.data), (y = !0))
        : (e =
            typeof t.placeholderData == `function`
              ? t.placeholderData(this.#u?.state.data, this.#u)
              : t.placeholderData),
        e !== void 0 && ((v = `success`), (h = a(i?.data, e, t)), (m = !0)));
    }
    if (t.select && h !== void 0 && !y)
      if (i && h === o?.data && t.select === this.#c) h = this.#l;
      else
        try {
          ((this.#c = t.select),
            (h = t.select(h)),
    ...
    let b = f.fetchStatus === `fetching`,
      ...
      O = {
        ...
        isFetchedAfterMount:
          f.dataUpdateCount > c.dataUpdateCount ||
          f.errorUpdateCount > c.errorUpdateCount,
        isFetching: b,
        isRefetching: b && !x,
        isLoadingError: C && !D,
...
function x(e, t) {
  return (
    d(t.enabled, e) !== !1 &&
    e.state.data === void 0 &&
    !(e.state.status === `error` && d(t.retryOnMount, e) === !1)
  );
}
function S(e, t) {
  return x(e, t) || (e.state.data !== void 0 && C(e, t, t.refetchOnMount));
}
function C(e, t, n) {
  if (d(t.enabled, e) !== !1 && y(t.staleTime, e) !== `static`) {
    let r = typeof n == `function` ? n(e) : n;
    return r === `always` || (r !== !1 && T(e, t));
  }
  return !1;
}
function w(e, t, n, r) {
...
function T(e, t) {
  return d(t.enabled, e) !== !1 && e.isStaleByTime(y(t.staleTime, e));
}
function E(e, t) {
...
var j = D.createContext(A()),
  M = () => D.useContext(j),
  N = (e, t, n) => {
    let r =
      n?.state.error && typeof e.throwOnError == `function`
        ? s(e.throwOnError, [n.state.error, n])
        : e.throwOnError;
  ...
  L = (e, t) => e.isLoading && e.isFetching && !t,
  R = (e, t) => e?.suspense && t.isPending,
  z = (e, t, n) =>
...
function B(e, t, n) {
  ...
  ((s._optimisticResults = r ? `isRestoring` : l ? `optimistic` : void 0),
    ...
    N(s, a, c),
    P(a));
  let u = !o.getQueryCache().get(s.queryHash),
    [d] = D.useState(() => new t(o, s)),
  ...
  if (
    (D.useSyncExternalStore(
      D.useCallback(
        (e) => {
          let t = p ? d.subscribe(g.batchCalls(e)) : _;
  ...
  if (
    ...
    throw f.error;
  return (
    o.getDefaultOptions().queries?._experimental_afterQuery?.(s, f),
    s.experimental_prefetchInRender &&
      !i.isServer() &&
      L(f, r) &&
      (u ? z(s, d, a) : c?.promise)?.catch(_).finally(() => {
        d.updateResult();
      }),
...
function H(e, t, n) {
  return V({
    queryKey: e,
    queryFn: () => r.get(t, { params: n?.params }),
    enabled: n?.enabled,
