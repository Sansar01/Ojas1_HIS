...
import { t as c } from "./useApiResource-B4231qiR.js";
import { t as l } from "./createLucideIcon-CYyYTezv.js";
import { t as u } from "./circle-check-B8_KDfYz.js";
import { t as d } from "./clock-cvWCFENs.js";
import { t as f } from "./trending-up-U9UA98WF.js";
import { n as p, t as m } from "./Kpi-B7fzN02H.js";
var h = l(`arrow-right`, [
...
function y() {
  let {
      ...
      isLoading: l,
      error: y,
    } = c([`dashboard-overview`], `/dashboard/overview`, { staleTime: 3e4 }),
    b = e?.overview;
  return (0, v.jsxs)(a, {
    children: [
      (0, v.jsxs)(`div`, {
      ...
      (0, v.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, v.jsx)(m, {
            icon: f,
            label: `Revenue`,
            value: l ? `—` : `₹${(b?.revenue ?? 84e4).toLocaleString()}`,
            delta: `15%`,
            tone: `primary`,
          }),
        ],
              ...
              children: [
                ...
                (0, v.jsxs)(
                  `div`,
                  {
                    ...
                    children: [
                      (0, v.jsx)(e.i, {
                        className: `w-4 h-4 mt-0.5 ${e.tone}`,
                      }),
                      (0, v.jsxs)(`div`, {
