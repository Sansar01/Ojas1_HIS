...
var u = class extends Error {
  ...
  d = `http://localhost:8000`.replace(/\/$/, ``);
function f(e, t) {
  let n = e.startsWith(`/`) ? e : `/${e}`;
  if (!t) return `${d}${n}`;
  let r = new URLSearchParams();
  Object.entries(t).forEach(([e, t]) => {
    t !== void 0 && r.set(e, String(t));
  });
  let i = r.toString();
  return `${d}${n}${i ? `?${i}` : ``}`;
}
...
async function m(e, t = {}) {
  let { body: n, params: r, auth: i = !0, headers: a, ...o } = t,
    s = async (t) => {
      let i = new Headers(a);
      return (
        ...
        fetch(f(e, r), {
          ...
          credentials: `include`,
          body:
            n !== void 0 && !(n instanceof FormData) ? JSON.stringify(n) : n,
        })
      );
    },
    c = i ? E() : null,
  ...
  if (l.status === 401 && i) {
    if (((c = await _()), !c))
      throw (
        ...
        new u(`Your session has expired. Please login again.`, 401)
      );
    l = await s(c);
  }
  let d = await p(l);
  if (!l.ok) throw new u(`Request failed with status ${l.status}`, l.status, d);
  return d;
}
var h = {
    get: (e, t) => m(e, { ...t, method: `GET` }),
    post: (e, t) => m(e, t),
    put: (e, t) => m(e, t),
    patch: (e, t) => m(e, t),
    delete: (e, t) => m(e, { ...t, method: `DELETE` }),
  },
  g = null;
async function _() {
  return (
    ...
    ((g = (async () => {
      try {
        let e = await fetch(`${d}/api/hospital/auth/refresh`, {
          method: `POST`,
          credentials: `include`,
        });
        if (!e.ok) return null;
        let t = await e.json();
        return t.accessToken ? (D(t.accessToken), t.accessToken) : null;
      } catch {
        return null;
      } finally {
        g = null;
...
async function O(e, t) {
  let n = h.post(`/api/hospital/auth/login`, {
      method: `POST`,
      headers: {
  ...
  let i = {
    name:
      ...
      r.user?.email ||
      `Hospital User`,
    role: x(r.user?.userType),
    designation: r.hospital?.name ? `${r.hospital.name} User` : `Hospital User`,
    initials: S(
      [r.user?.firstName, r.user?.lastName].filter(Boolean).join(` `) ||
        r.user?.email ||
        `Hospital User`,
    ...
    hospitalCode: r.hospital?.code,
    hospitalId: r.hospital?.id,
    userId: r.user?.id,
    forcePasswordChange: r.forcePasswordChange,
  };
  return (w(i), D(r.accessToken), i);
}
function k(e, t) {
  let n = y[e];
  return (
    n === `all` || t === `/` || n.some((e) => t === e || t.startsWith(e + `/`))
  );
}
async function A() {
  try {
    return (
      await h.post(`/api/hospital/auth/logout`, {
        method: `POST`,
        credentials: `include`,
      }),
      !0
    ...
    return (console.error(`Logout API failed:`, e), !1);
  } finally {
    T();
  }
}
