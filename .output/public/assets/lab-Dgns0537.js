          ...
          children: [
            (0, r.jsx)(`thead`, {
              children: (0, r.jsxs)(`tr`, {
                ...
                children: [
                  (0, r.jsx)(`th`, { className: `pb-2`, children: `Order` }),
                  (0, r.jsx)(`th`, { children: `Patient` }),
                  (0, r.jsx)(`th`, { children: `Tests` }),
                  (0, r.jsx)(`th`, { children: `Time` }),
                    ...
                    children: [
                      ...
                      (0, r.jsx)(`td`, {
                        children: (0, r.jsx)(`span`, {
                          className: `text-[10px] px-1.5 py-0.5 rounded ${e[4] === `Reported` ? `bg-success/15 text-success` : e[4] === `In Progress` ? `bg-info/15 text-info` : e[4] === `Pending` ? `bg-warning/20 text-warning-foreground` : `bg-primary/10 text-primary`}`,
                          children: e[4],
                        }),
                      }),
                    ],
