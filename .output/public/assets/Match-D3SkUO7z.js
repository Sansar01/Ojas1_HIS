...
import { d as n, f as r, l as i } from "./auth-CRzH69JE.js";
var a = t((e) => {
    var t = r();
    function n(e) {
...
function A(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    i;
  for (; (i = t.exec(e)) !== null;)
    ((r += E(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += E(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function N(e, t, n, r, i, a, o) {
  ...
  if (n.children) for (let r of n.children) N(e, t, r, s, i, a, o);
}
function ce(e, t) {
...
function le(e, t) {
  let n = F(`/`),
    r = new Uint16Array(6);
  for (let t of e) N(!1, r, t, 1, n, 0);
  (P(n), (t.masksTree = n), (t.flatCache = ie(1e3)));
}
function ue(e, t) {
  e ||= `/`;
...
function L(e, t, n, r, i) {
  ...
  return (
    o ||
      ((o = F(`/`)),
      N(t, new Uint16Array(6), { from: e }, 1, o, 0),
...
function R(e, t, n = !1) {
  ...
  return (a && (a.branch = me(a.route)), t.matchCache.set(r, a), a);
}
function de(e) {
...
function Ce(e, t, n) {
  return Se(e, n) === Se(t, n);
}
function we({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  let i = t.startsWith(`/`),
    a = !i && t === `.`,
    o;
  if (r) {
  ...
  c.length > 1 &&
    (s(c) === `` ? n === `never` && c.pop() : n === `always` && c.push(``));
  let l = ye(c.join(`/`)) || `/`;
...
function De({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
  if (!e || e === `/`)
...
var Ae = `tsr-scroll-restoration-v1_3`,
  je = ke();
function Me() {
  try {
    return JSON.parse(je?.getItem(`tsr-scroll-restoration-v1_3`) || `{}`);
  } catch {
    return {};
  }
}
function Ne() {
  try {
    je?.setItem(Ae, JSON.stringify(G));
  } catch {}
}
var G = Me(),
  Pe = `data-scroll-restoration-id`,
  Fe = (e) => e.state.__TSR_key || e.href;
function Ie(e) {
...
function Ve(e, t) {
  let n = t ?? e.options.scrollRestoration,
    r = e._scroll;
  n && (r.restoring = !0);
  let i = e.options.getScrollRestorationKey || Fe,
    a = new Set(),
    o = (e) => {
      let t = (G[e] ||= {});
      for (let e of a)
        e === document
          ? (t[Re] = { scrollX, scrollY })
          : e.isConnected &&
            (t[Ie(e)] = { scrollX: e.scrollLeft, scrollY: e.scrollTop });
    };
  (n &&
    !r.restoration &&
    ((r.restoration = !0),
    ...
    addEventListener(`pagehide`, () => {
      (o(i(e.stores.resolvedLocation.get() ?? e.stores.location.get())), Ne());
    })),
    !r.reset &&
      ((r.reset = !0),
          ...
          if (e) {
            ...
            for (let n in e) {
              if (n === Re) {
                ...
                let e = ze(n);
                if (!e || (s && o && ((l ??= Be(o)), l.has(e)))) continue;
              }
              ((t ||= G[u] = {}), (t[n] ??= e[n]));
            }
          }
...
var st = (e) => {
    ...
    if (!(!K(n) && !W(n)))
      throw K(n) && n.redirectHandled && !n.options.reloadDocument
        ...
        : (t &&
            ...
            W(n) && !n.routeId && (n.routeId = t.routeId),
  ...
  pt = (e, t, n) => {
    ...
    ((e.firstBadMatchIndex ??= t), J(e, e.router.getMatch(r), n));
    try {
      a.options.onError?.(n);
    } catch (t) {
      ((n = t), J(e, e.router.getMatch(r), n));
    }
    (e.updateMatch(
      r,
      (e) => (
      ...
      !e.preload && !K(n) && !W(n) && (e.serialError ??= n));
  },
  mt = (e, t, n, r) => {
    ...
    if (
      e.onReady &&
      !lt(e, t) &&
      (n.options.loader || n.options.beforeLoad || Tt(n)) &&
      typeof i == `number` &&
      i !== 1 / 0 &&
  ...
  gt = (e, t, n, r) => {
    ...
    i._nonReactive.loadPromise = x(() => {
      (a?.resolve(), (a = void 0));
    });
    let { paramsError: o, searchError: s } = i;
    (o && pt(e, n, o), s && pt(e, n, s), mt(e, t, r, i));
    ...
    i._nonReactive.beforeLoadPromise = x();
    let f = { ...q(e, n, !1), ...i.__routeContext },
  ...
  bt = async (e, t, n, r, i) => {
    try {
      ...
      try {
        ...
        (s && (await s),
          W(t) && (await i.options.notFoundComponent?.preload?.()),
          J(e, e.router.getMatch(n), t));
        try {
          i.options.onError?.(t);
        } catch (t) {
          ((o = t), J(e, e.router.getMatch(n), t));
        }
        (!K(o) && !W(o) && (await wt(i, [`errorComponent`])),
          e.updateMatch(n, (t) => ({
            ...t,
            error: o,
            context: q(e, r),
      ...
      (r && (r._nonReactive.loaderPromise = void 0), J(e, r, t));
    }
  },
  xt = async (e, t, n) => {
    ...
    if (dt(e, i)) {
      ...
      if (t._nonReactive.loaderPromise) {
        ...
        (a && J(e, n, a), n.status === `pending` && (await r(l, t, s, n, c)));
      } else {
        let n = l && !e.router.stores.matchStores.has(i),
          a = e.router.getMatch(i);
        ((a._nonReactive.loaderPromise = x()),
...
function Tt(e) {
  for (let t of Et) if (e.options[t]?.preload) return !0;
  return !1;
}
var Et = [
    `component`,
...
function At(e, t) {
  t ||= {};
  let n = Pt();
  return { ...t, key: n, __TSR_key: n, [Y]: e };
}
function jt(e) {
  ...
  if (!t.history.state?.__TSR_key && !t.history.state?.key) {
    let e = Pt();
    t.history.replaceState({ [Y]: 0, key: e, __TSR_key: e }, ``);
  }
  let l = c(),
    u,
    d = !1,
    ...
    C = kt({
      ...
      destroy: () => {
        ((t.history.pushState = n),
          ...
          t.removeEventListener(Ot, S, { capture: !0 }),
          t.removeEventListener(Dt, x));
      },
      onBlocked: () => {
        u && l !== u && (l = u);
      },
  ...
  return (
    t.addEventListener(Ot, S, { capture: !0 }),
    t.addEventListener(Dt, x),
...
var Lt = class {
      ...
      ((this.tempLocationKey = `${Math.round(Math.random() * 1e7)}`),
        ...
        (this.update = (e) => {
          ...
          if (!this.stores && this.latestLocation) {
            ...
            ((this.batch = e.batch),
              (this.stores = it(Bt(this.latestLocation), e)),
              Ve(this));
          }
          let a = !1,
          ...
          let n = ({ pathname: e, search: n, hash: r, href: i, state: a }) => {
              ...
              return (
                (s.search = l),
                {
                  ...
                  publicHref: i,
                  pathname: A(s.pathname).path,
                  external: !!this.rewrite && s.origin !== this.origin,
                  searchStr: l,
                  search: m(t?.search, c),
                  hash: A(s.hash.slice(1)).path,
                  state: h(t?.state, a),
                }
              );
            },
        ...
        (this.buildLocation = (e) => {
          let t = (t = {}) => {
              ...
              let i =
                ...
                u = a ? this.resolvePathWithBase(c, a) : c,
                d =
                  t.params === !1 || t.params === null
                    ? Object.create(null)
                    : (t.params ?? !0) === !0
                      ? s
                      : Object.assign(s, l(t.params, s)),
                p = this.routesByPath[U(u)],
                g;
              if (p) g = this.getRouteBranch(p);
              else if (u.includes(`$`)) g = [];
              else {
                ...
                (g.forEach((t) => {
                  if (t.options.validateSearch)
                    try {
                      Object.assign(
                        e,
                        Vt(t.options.validateSearch, { ...e, ...v }),
                      );
                    } catch {}
                }),
                  (v = e));
              ...
              let y = this.options.stringifySearch(v),
                b =
                  t.hash === !0 ? n.hash : t.hash ? l(t.hash, n.hash) : void 0,
                x = b ? `#${b}` : ``,
                S =
                  t.state === !0 ? n.state : t.state ? l(t.state, n.state) : {};
              S = h(n.state, S);
              let C = `${_}${y}${x}`,
                w,
                T,
            ...
            n = (n = {}, r) => {
              ...
              if (!a) {
                ...
                if (this.options.routeMasks) {
                  let o = ue(i.pathname, this.processedTree);
                  if (o) {
                    ...
                    let { from: i, params: s, ...c } = o.route,
                      u =
                        s === !1 || s === null
                          ...
                          : (s ?? !0) === !0
                            ? n
                            : Object.assign(n, l(s, n));
                    ((r = { from: e.from, ...c, params: u }), (a = t(r)));
                  }
                }
              }
        ...
        (this.commitLocation = async ({
          ...
          let r,
            i = () => {
              ...
              let t = b(n.state, this.latestLocation.state);
              return (
                e.forEach((e) => {
                  delete n.state[e];
                }),
            ...
            a = U(this.latestLocation.href) === U(n.href),
            o = this.commitLocationPromise;
          if (
            ((this.commitLocationPromise = x(() => {
              (o?.resolve(), (o = void 0));
            })),
            a && i())
          )
        ...
        (this.buildAndCommitLocation = ({
          ...
          if (a) {
            let t = this.history.location.state.__TSR_index,
              n = Nt(a, { __TSR_index: e ? t : t + 1 }),
              r = new URL(n.pathname, this.origin);
            ((o.to = et(this.rewrite, r).pathname),
        ...
        (this.navigate = async ({
          ...
          if ((a && !t && (t = !0), t)) {
            ...
            let t = !a && r ? r : n;
            if (ee(t, this.protocolAllowlist)) return;
            if (!i.ignoreBlocker) {
              ...
              this.startTransition(async () => {
                try {
                  ...
                  let n = this.latestLocation,
                    r = It(n, this.stores.resolvedLocation.get());
          ...
          if (
            ...
            if (typeof t == `object` && this.isViewTransitionTypesSupported) {
              let r = this.latestLocation,
                ...
                a = typeof t.types == `function` ? t.types(It(r, i)) : t.types;
              if (a === !1) {
                e();
                return;
              }
        ...
        (this.resolveRedirect = (e) => {
          ...
          if (
            ...
            ee(e.options.href, this.protocolAllowlist)
          )
        ...
        (this.matchRoute = (e, t) => {
          ...
          return !a || (e.params && !b(a.rawParams, e.params, { partial: !0 }))
            ? !1
            : (t?.includeSearch ?? !0)
              ? b(i.search, r.search, { partial: !0 })
                ? a.rawParams
                : !1
              : a.rawParams;
        }),
        ...
        this.update({
          ...
          protocolAllowlist: e.protocolAllowlist ?? D,
        }),
    ...
    getRouteBranch(e) {
      ...
      return (t || ((t = me(e)), this.routeBranchCache.set(e, t)), t);
    }
    get looseRoutesById() {
    ...
    matchRoutesInternal(e, t) {
      let n = this.getMatchedRoutes(e.pathname),
        ...
        { matchedRoutes: a } = n,
        o = !1;
      (r ? r.path !== `/` && i[`**`] : U(e.pathname)) &&
        (this.options.notFoundRoute
          ? (a = [...a, this.options.notFoundRoute])
          : (o = !0));
      let s = o ? Gt(this.options.notFoundMode, a) : void 0,
        c = Array(a.length),
        l = new Map();
      for (let e of this.stores.matchStores.values())
      ...
      for (let n = 0; n < a.length; n++) {
          ...
          f;
        {
          ...
          try {
            let e = Vt(r.options.validateSearch, { ...n }) ?? void 0;
            ((u = { ...n, ...e }), (d = { ...i, ...e }), (f = void 0));
          } catch (e) {
            let r = e;
            if (
              (e instanceof Rt || (r = new Rt(e.message, { cause: e })),
              t?.throwOnError)
            )
              throw r;
            ((u = n), (d = {}), (f = r));
        ...
        let p = r.options.loaderDeps?.({ search: u }) ?? ``,
          g = p ? JSON.stringify(p) : ``,
          { interpolatedPath: _, usedParams: v } = De({
            path: r.fullPath,
            params: i,
            decoder: this.pathParamsDecoder,
            server: this.isServer,
        ...
        if (!b)
          try {
            ...
            if (
              ((w = W(e) || K(e) ? e : new zt(e.message, { cause: e })),
              t?.throwOnError)
            )
              throw w;
          }
        ...
        if (b)
          E = {
            ...
            params: S?.params ?? i,
            _strictParams: C,
            search: m(S ? S.search : b.search, u),
            _strictSearch: d,
          };
        else {
          let e =
            r.options.loader || r.options.beforeLoad || r.lazyFn || Tt(r)
              ? `pending`
              : `success`;
          E = {
            id: y,
            ...
            _nonReactive: { loadPromise: x() },
            __beforeLoadContext: void 0,
            context: {},
            abortController: new AbortController(),
            fetchCount: 0,
            cause: T,
            loaderDeps: S ? h(S.loaderDeps, p) : p,
            invalid: !1,
            preload: !1,
            links: void 0,
            scripts: void 0,
        ...
        (t?.preload || (E.globalNotFound = s === r.id), (E.searchError = f));
        let D = this.getParentContext(o);
        ((E.context = { ...D, ...E.__routeContext, ...E.__beforeLoadContext }),
          (c[n] = E));
      }
      for (let t = 0; t < c.length; t++) {
        let n = c[t],
          ...
          o = l.get(n.routeId);
        if (((n.params = o ? m(o.params, i) : i), !a)) {
          let i = c[t - 1],
    ...
    matchRoutesLightweight(e) {
      let t = s(this.stores.matchesId.get()),
      ...
      for (let e of r)
        try {
          Object.assign(o, Vt(e.options.validateSearch, o));
        } catch {}
      let c = t && this.stores.matchStores.get(t)?.get(),
        l = c && c.routeId === a.id && c.pathname === e.pathname,
        u;
      if (l) u = c.params;
      else {
...
function Vt(e, t) {
  ...
  if (`~standard` in e) {
    ...
    if (n.issues)
      throw new Rt(JSON.stringify(n.issues, void 0, 2), { cause: n });
    return n.value;
  }
  return `parse` in e ? e.parse(t) : typeof e == `function` ? e(t) : {};
}
function Ht({ pathname: e, routesById: t, processedTree: n }) {
...
function Ut({ search: e, dest: t, destRoutes: n, _includeValidateSearch: r }) {
  return Wt(n)(e, t, r ?? !1);
}
function Wt(e) {
  let t,
...
var qt = `Error preloading route! ☝️`,
  X = e(r(), 1),
  Jt = X.use,
  Yt = typeof window < `u` ? X.useLayoutEffect : X.useEffect;
function Xt(e) {
  let t = X.useRef({ value: e, prev: null }),
    n = t.current.value;
...
var $t = e(o(), 1),
  Z = n();
function en(e) {
  let t = e.errorComponent ?? nn;
  return (0, Z.jsx)(tn, {
    getResetKey: e.getResetKey,
    onCatch: e.onCatch,
    children: ({ error: n, reset: r }) =>
      n ? X.createElement(t, { error: n, reset: r }) : e.children,
  });
}
var tn = class extends X.Component {
  constructor(...e) {
      ...
      t
        ? (0, Z.jsx)(`div`, {
            children: (0, Z.jsx)(`pre`, {
              ...
              children: e.message
                ? (0, Z.jsx)(`code`, { children: e.message })
                : null,
            }),
          })
        : null,
...
function rn({ children: e, fallback: t = null }) {
  return an()
...
var sn = X.createContext(void 0),
  cn = X.createContext(void 0),
  ln = t((e) => {
    var t = r();
    function n(e, t) {
...
function Q(e, t, n = pn) {
  ...
  return (0, fn.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
var mn = {
  get() {},
  subscribe() {
...
function _n(e, t) {
  let n = i(),
    ...
    L = X.useMemo(() => En(le, ue, n.history, x), [x, ue, le, n.history]),
    R = X.useMemo(() => {
      if (L?.external) return ee(L.href, n.protocolAllowlist) ? void 0 : L.href;
      if (!Dn(c) && !(typeof c != `string` || c.indexOf(`:`) === -1))
        try {
    ...
    de = X.useMemo(() => {
      if (R) return !1;
      if (s?.exact) {
        if (!Ce(F.pathname, I.pathname, n.basepath)) return !1;
      } else {
        let e = Se(F.pathname, n.basepath),
          t = Se(I.pathname, n.basepath);
        if (!(
          e.startsWith(t) &&
      ...
      return (s?.includeSearch ?? !0) &&
        ...
        ? !1
        : !s?.includeHash || (ce && F.hash === I.hash);
    }, [
      s?.exact,
      s?.explicitUndefined,
      s?.includeHash,
    ...
    fe = de ? (l(a, {}) ?? yn) : vn,
    z = de ? vn : (l(o, {}) ?? vn),
    pe = [C, fe.className, z.className].filter(Boolean).join(` `),
    me = (S || fe.style || z.style) && { ...S, ...fe.style, ...z.style },
    [he, ge] = X.useState(!1),
    B = X.useRef(!1),
    V = e.reloadDocument || R ? !1 : (u ?? n.options.defaultPreload),
    _e = d ?? n.options.defaultPreloadDelay ?? 0,
    H = X.useCallback(() => {
      n.preloadRoute({ ...P, _builtLocation: I }).catch((e) => {
        (console.warn(e), console.warn(qt));
      });
    }, [n, P, I]);
  (Zt(
    r,
    ...
    wn,
    { disabled: !!x || V !== `viewport` },
  ),
    X.useEffect(() => {
      B.current || (!x && V === `render` && (H(), (B.current = !0)));
    }, [x, H, V]));
  let ve = (e) => {
  ...
  return {
    ...
    onBlur: Tn([T, U]),
    onFocus: Tn([E, ye]),
    onMouseEnter: Tn([D, ye]),
    onMouseLeave: Tn([O, U]),
    onTouchStart: Tn([k, be]),
    disabled: !!x,
    target: y,
    ...(me && { style: me }),
    ...(pe && { className: pe }),
...
function An(e) {
  ...
  return (0, Z.jsx)(en, {
    getResetKey: () => n,
    onCatch: (t, n) => {
      if (W(t)) e.onCatch?.(t, n);
      else throw t;
    },
    errorComponent: ({ error: t }) => {
      if (W(t)) return e.fallback?.(t);
      throw t;
    },
    children: e.children,
  });
...
var Nn = (e, t) =>
  ...
  Pn = (e, t) => e[0] === t[0] && e[1] === t[1],
  Fn = X.memo(function ({ matchId: e }) {
    let t = i(),
...
function In({ router: e, matchId: t, resetKey: n, matchState: r }) {
  let i = e.routesById[r.routeId],
    ...
    f = s ? en : $,
    p = l ? An : $;
  return (0, Z.jsxs)(i.isRoot ? (i.options.shellComponent ?? $) : $, {
    children: [
      (0, Z.jsx)(sn.Provider, {
        value: t,
        children: (0, Z.jsx)(d, {
          ...
          children: (0, Z.jsx)(f, {
            ...
            errorComponent: s || nn,
            onCatch: (e, t) => {
              if (W(e)) throw ((e.routeId ??= r.routeId), e);
              c?.(e, t);
            },
            children: (0, Z.jsx)(p, {
              fallback: (e) => {
                if (
                  ...
                  throw e;
                return X.createElement(l, e);
              },
              children:
                u || r._displayPending
                  ? (0, Z.jsx)(rn, {
                      fallback: o,
                      children: (0, Z.jsx)(Rn, { matchId: t }),
                    })
                  : (0, Z.jsx)(Rn, { matchId: t }),
            }),
          }),
        }),
      }),
      r.parentRouteId === `__root__`
        ? (0, Z.jsxs)(Z.Fragment, {
            children: [(0, Z.jsx)(Ln, {}), (e.options.scrollRestoration, null)],
          })
        : null,
    ],
  });
...
function Ln() {
  ...
  return (
    Yt(() => {
      ...
      (n &&
        (!r || r.href !== n.href) &&
        e.emit({ type: `onRendered`, ...It(e.stores.location.get(), r ?? n) }),
        (t.current = n));
    }, [Q(e.stores.resolvedLocation, (e) => e?.state.__TSR_key), e]),
    null
  );
}
var Rn = X.memo(function ({ matchId: e }) {
    let t = i(),
    ...
    let a = Q(r, (e) => e),
      ...
      c = X.useMemo(() => {
        let e = (
          t.routesById[o].options.remountDeps ?? t.options.defaultRemountDeps
        )?.({
          routeId: o,
      ...
      l = X.useMemo(() => {
        ...
        return e ? (0, Z.jsx)(e, {}, c) : (0, Z.jsx)(zn, {});
    ...
    if (a.status === `notFound`) return (W(a.error) || j(), Mn(t, s, a.error));
    if (a.status === `redirected`)
      throw (K(a.error) || j(), n(a, `loadPromise`));
  ...
  zn = X.memo(function () {
    let e = i(),
      ...
      a;
    {
      let i = t ? e.stores.matchStores.get(t) : void 0;
      (([n, r] = Q(i, (e) => [e?.routeId, e?.globalNotFound ?? !1], Pn)),
        (a = Q(e.stores.matchesId, (e) => e[e.findIndex((e) => e === t) + 1])));
    }
    let o = n ? e.routesById[n] : void 0,
      s = e.options.defaultPendingComponent
        ? (0, Z.jsx)(e.options.defaultPendingComponent, {})
        : null;
    if (r) return (o || j(), Mn(e, o, void 0));
    if (!a) return null;
    let c = (0, Z.jsx)(Fn, { matchId: a });
    return n === `__root__`
      ? (0, Z.jsx)(X.Suspense, { fallback: s, children: c })
      : c;
  });
export {
  b as A,
