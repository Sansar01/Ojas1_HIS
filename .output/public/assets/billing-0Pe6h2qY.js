...
import { g as t, m as n, t as r, w as i } from "./AppLayout-x7TZ9xUn.js";
import { t as a } from "./useApiResource-B4231qiR.js";
import { t as o } from "./createLucideIcon-CYyYTezv.js";
import { t as s } from "./id-card-DYUaZK19.js";
import { t as c } from "./phone-BcNM8S35.js";
import { t as l } from "./user-uWaBTeu7.js";
import { n as u } from "./Kpi-B7fzN02H.js";
var d = o(`droplet`, [
    [
      `path`,
      {
  ...
  _ = [
    ...
    { cat: `Investigations`, n: `2D Echo`, r: 2e3, q: 1 },
...
function v() {
  let {
      ...
      isLoading: o,
      error: v,
    } = a([`billing-summary`], `/billing/summary`, { staleTime: 3e4 }),
    y = _.reduce((e, t) => e + t.r * t.q, 0),
    b = e?.billSummary?.discount ?? 301.5,
    x = (e?.billSummary?.total ?? y) - b,
    S = e?.billSummary?.insurancePaid ?? 3445.65,
    C = e?.billSummary?.payableByPatient ?? 382.85;
  return (0, g.jsxs)(r, {
    children: [
      (0, g.jsx)(`div`, {
          ...
          (0, g.jsxs)(u, {
            ...
            children: [
              (0, g.jsx)(`div`, {
                ...
                children: [`All 24`, `Pending 16`, `Billing 5`, `Done 3`].map(
                  (e, t) =>
                    (0, g.jsx)(
                      `button`,
                      {
                        className: `px-2 py-1 border-b-2 ${t === 0 ? `border-primary text-primary` : `border-transparent text-muted-foreground`}`,
                        children: e,
                      },
                      e,
                    ),
                    ...
                    children: [
                      (0, g.jsxs)(`select`, {
                        ...
                        children: [
                          ...
                          (0, g.jsx)(`option`, { children: `Consultation` }),
                          (0, g.jsx)(`option`, { children: `Investigations` }),
                          (0, g.jsx)(`option`, { children: `Medications` }),
                          (0, g.jsx)(`option`, { children: `Procedures` }),
                          (0, g.jsx)(`option`, { children: `Consumables` }),
                        ],
                      }),
                      (0, g.jsxs)(`select`, {
                        className: `md:col-span-3 border rounded-lg px-2 py-2 text-sm bg-background`,
                        children: [
                          ...
                          (0, g.jsx)(`option`, { children: `Cardiology` }),
                          (0, g.jsx)(`option`, { children: `Radiology` }),
                          (0, g.jsx)(`option`, { children: `Pathology` }),
                          (0, g.jsx)(`option`, { children: `Tablet` }),
                          (0, g.jsx)(`option`, { children: `Injection` }),
                          (0, g.jsx)(`option`, { children: `Syrup` }),
                        ],
                      }),
                      (0, g.jsxs)(`div`, {
                        ...
                        children: [
                          (0, g.jsx)(t, {
                            className: `w-4 h-4 absolute left-2.5 top-1/2 -translate-y-1/2 text-muted-foreground`,
                          }),
                          (0, g.jsx)(`input`, {
                            type: `text`,
                      ...
                      (0, g.jsx)(`thead`, {
                        children: (0, g.jsxs)(`tr`, {
                          ...
                          children: [
                            ...
                            (0, g.jsx)(`th`, { children: `Rate` }),
                            (0, g.jsx)(`th`, { children: `Qty` }),
                            (0, g.jsx)(`th`, {
                          ...
                          (0, g.jsxs)(
                            `tr`,
                            {
                              ...
                              children: [
                                ...
                                (0, g.jsx)(`td`, { children: e.r.toFixed(2) }),
                                (0, g.jsx)(`td`, { children: e.q }),
                                (0, g.jsxs)(`td`, {
                                  className: `text-right font-semibold`,
                                  children: [`₹`, (e.r * e.q).toFixed(2)],
                                }),
                              ],
                            },
                            t,
                ...
                children: (0, g.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, g.jsxs)(`div`, {
                      ...
                      children: [
                        (0, g.jsx)(`span`, { children: `Discount (5%)` }),
                        (0, g.jsxs)(`span`, {
                    ...
                    (0, g.jsxs)(`div`, {
                      ...
                      children: [
                        (0, g.jsx)(`span`, { children: `Tax (GST 0%)` }),
                        (0, g.jsx)(`span`, { children: `₹0.00` }),
                      ],
                    }),
                    (0, g.jsxs)(`div`, {
                      className: `flex justify-between font-bold text-lg pt-2 border-t`,
                      children: [
                        (0, g.jsx)(`span`, { children: `Net Amount` }),
                        (0, g.jsxs)(`span`, {
                  ...
                  (0, g.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, g.jsxs)(`div`, {
                        ...
                        children: [
                          (0, g.jsx)(`span`, { children: `Insurance Paid` }),
                          (0, g.jsxs)(`span`, {
                            className: `font-bold`,
