...
import { d as r, m as i, t as a, u as o } from "./AppLayout-x7TZ9xUn.js";
import { t as s } from "./useApiResource-B4231qiR.js";
...
import { n as d, t as f } from "./Kpi-B7fzN02H.js";
var p = c(`circle-x`, [
...
function x() {
  let [e, t] = (0, h.useState)(0),
    [n, c] = (0, h.useState)(0),
    [x, S] = (0, h.useState)(`04:00 PM`),
    [C, w] = (0, h.useState)(`physical`),
    {
      data: T,
      isLoading: E,
      error: D,
    } = s([`appointment-metrics`], `/appointments/metrics`, { staleTime: 3e4 }),
    O = T?.appointmentMetrics;
  return (0, g.jsxs)(a, {
    children: [
      (0, g.jsxs)(`div`, {
        className: `mb-6`,
      ...
      (0, g.jsxs)(`div`, {
        ...
        children: [
          (0, g.jsx)(f, {
            ...
            value: E ? `—` : `${O?.todayAppointments ?? 68}`,
            delta: `15%`,
            tone: `primary`,
          }),
          (0, g.jsx)(f, {
          ...
          (0, g.jsx)(f, {
            ...
            value: E ? `—` : `${O?.teleconsultations ?? 26}`,
            delta: `20%`,
            tone: `primary`,
          }),
          (0, g.jsx)(f, {
          ...
          (0, g.jsx)(f, {
            icon: p,
            label: `Cancelled`,
            value: E ? `—` : `${O?.cancelled ?? 8}`,
            tone: `destructive`,
          }),
          (0, g.jsx)(f, {
            icon: u,
            label: `Avg Wait`,
            value: E ? `—` : `${O?.avgWaitMinutes ?? 18}m`,
            tone: `warning`,
          }),
        ],
      }),
                ...
                children: [
                  ...
                  (0, g.jsxs)(
                    `div`,
                    {
                      ...
                      children: [
                        (0, g.jsx)(`div`, {
                          className: `w-6 h-6 rounded-full flex items-center justify-center font-semibold ${t === 0 ? `bg-primary text-primary-foreground` : `bg-muted text-muted-foreground`}`,
                          children: t + 1,
                        }),
                        (0, g.jsx)(`span`, {
                          className:
                      ...
                      (0, g.jsx)(`div`, {
                        ...
                        children: _.map((n, r) =>
                          (0, g.jsx)(
                            ...
                            {
                              onClick: () => t(r),
                              className: `w-full text-left p-3 border-b last:border-0 hover:bg-muted ${r === e ? `bg-primary/5 border-l-4 border-l-primary` : ``}`,
                              children: (0, g.jsxs)(`div`, {
                                className: `flex items-center gap-2`,
                                children: [
                                  (0, g.jsx)(`div`, {
                                    className: `w-9 h-9 rounded-full bg-muted flex items-center justify-center text-xs font-semibold`,
                                    children: n.n.split(` `)[1][0],
                                  }),
                                  (0, g.jsxs)(`div`, {
                                  ...
                                  (0, g.jsx)(`span`, {
                                    className: `text-[9px] px-1.5 py-0.5 rounded ${n.status === `Available` ? `bg-success/15 text-success` : `bg-warning/20 text-warning-foreground`}`,
                                    children: n.status,
                                  }),
                                ],
                              }),
                          ...
                          (0, g.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, g.jsxs)(`div`, {
                                ...
                                children: [`MBBS, MD (`, _[e].s, `)`],
                              }),
                              (0, g.jsxs)(`div`, {
                                className: `text-xs text-muted-foreground`,
                                children: [_[e].s, ` • `, _[e].exp],
                              }),
                            ],
                          }),
                          (0, g.jsxs)(`div`, {
                            ...
                            children: [
                              (0, g.jsx)(`button`, {
                                onClick: () => w(`physical`),
                                className: `px-3 py-2 rounded-lg text-xs border ${C === `physical` ? `bg-primary/10 border-primary text-primary` : ``}`,
                                children: `Physical Visit`,
                              }),
                              (0, g.jsx)(`button`, {
                                onClick: () => w(`tele`),
                                className: `px-3 py-2 rounded-lg text-xs border ${C === `tele` ? `bg-primary/10 border-primary text-primary` : ``}`,
                      ...
                      (0, g.jsx)(`div`, {
                        ...
                        children: v.map((e, t) =>
                          (0, g.jsxs)(
                            ...
                            {
                              onClick: () => c(t),
                              className: `min-w-[70px] p-2 rounded-lg border text-center ${t === n ? `bg-primary text-primary-foreground border-primary` : ``}`,
                              children: [
                                (0, g.jsx)(`div`, {
                                  className: `text-xs`,
                                  children: e.d,
                          ...
                          (0, g.jsx)(`div`, {
                            ...
                            children: y.map((e) =>
                              (0, g.jsx)(
                                ...
                                {
                                  onClick: () => S(e),
                                  className: `py-2 rounded-lg border text-xs ${x === e ? `bg-primary text-primary-foreground border-primary` : `border-success/30 text-success hover:bg-success/5`}`,
                                  children: e,
                                },
                                e,
                              ),
            ...
            children: [
              (0, g.jsx)(`div`, {
                ...
                children: [
                  ...
                  [
                    `Type`,
                    C === `physical` ? `Physical Visit` : `Teleconsultation`,
                  ],
                  [`Date`, `${v[n].n}, 2025`],
                  [`Time`, x],
                  [`Duration`, `20 Minutes`],
