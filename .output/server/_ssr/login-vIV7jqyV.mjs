...
import { a as loginWithBackend, i as getUser } from "./auth-BmroyoyF.mjs";
import { i as require_react, r as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { _ as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { U as LogIn, W as LoaderCircle, X as Heart } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-vIV7jqyV.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function LoginPage() {
	const navigate = useNavigate();
	const [email, setEmail] = (0, import_react.useState)("admin@abc.com");
	const [password, setPassword] = (0, import_react.useState)("GffjuHr%!EK4");
	...
	const onSubmit = async (e) => {
		...
		try {
			if ((await loginWithBackend(email.trim(), password)).forcePasswordChange) navigate({ to: "/change-password" });
			else navigate({ to: "/" });
		} catch (err) {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "w-6 h-6 text-primary fill-primary" })
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [
								isSubmitting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogIn, { className: "w-4 h-4" }),
								" ",
								"Sign in"
							]
						})
