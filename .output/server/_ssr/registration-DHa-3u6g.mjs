        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mb-5 p-3 rounded-lg bg-primary/5 border border-primary/20 flex gap-2",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    placeholder: "Search by Mobile / UHID / ABHA ID / Aadhaar…",
                    className:
                      "flex-1 px-3 py-2 rounded-lg border bg-card text-sm",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    className:
                      "px-4 py-2 rounded-lg bg-primary text-primary-foreground text-sm",
                    children: "Search",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "w-full aspect-square rounded-lg border-2 border-dashed flex flex-col items-center justify-center text-muted-foreground",
                        children: [
                          ...
                          "div",
                          {
                            ...
                            children: ["Male", "Female", "Other"].map((g) =>
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                ...
                                {
                                  className:
                                    "flex-1 px-2 py-2 border rounded-lg text-xs hover:bg-muted",
                                  children: g,
                                },
                                g,
                              ),
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        children: ["new", "revisit", "emergency"].map((v) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className: "grid grid-cols-3 gap-2",
                        children: ["self", "insurance", "corporate"].map((p) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                      ...
                      payType === "self" &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "mt-3 p-3 rounded-lg bg-muted/40 text-xs text-muted-foreground",
                          children:
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mt-4 p-3 rounded-lg bg-info/10 border border-info/20 text-xs",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
