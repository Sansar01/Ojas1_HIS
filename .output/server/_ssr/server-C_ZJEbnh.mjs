...
import {
  A as isResolvedRedirect,
  D as resolveManifestCssLink,
  E as resolveManifestAssetLink,
  F as invariant,
  M as rootRouteId,
  N as isNotFound,
  O as executeRewriteInput,
  T as getStylesheetHref,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } =
    await import("../_tanstack-start-manifest_v-Bsj8Ocq-.mjs");
