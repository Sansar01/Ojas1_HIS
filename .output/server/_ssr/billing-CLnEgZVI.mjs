...
//#region node_modules/.nitro/vite/services/ssr/assets/billing-CLnEgZVI.js
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "w-14 h-14 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-lg",
              children: "RP",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex-1 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "text-[10px] uppercase text-muted-foreground flex items-center gap-1",
                      children: [
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "text-[10px] uppercase text-muted-foreground flex items-center gap-1",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IdCard, {
                          className: "w-3 h-3",
                        }),
                        "UHID / MRN",
                      ],
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                        className:
                          "md:col-span-3 border rounded-lg px-2 py-2 text-sm bg-background",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "option",
                            {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
                            className:
                              "w-4 h-4 absolute left-2.5 top-1/2 -translate-y-1/2 text-muted-foreground",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                            type: "text",
                            placeholder:
                              "Search item, medicine, test or service…",
                            className:
                              "w-full border rounded-lg pl-8 pr-3 py-2 text-sm bg-background",
                          }),
                        ],
                      }),
                    ],
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    className:
                      "p-3 rounded-lg border flex flex-col items-center gap-1 text-xs",
                    children: [
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "flex justify-between text-warning-foreground pt-2 border-t",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    className:
                      "w-full mt-4 py-2.5 bg-success text-success-foreground rounded-lg font-medium text-sm",
                    children: "Collect Payment (F9)",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    className:
                      "w-full mt-2 py-2 border rounded-lg text-sm flex items-center justify-center gap-2",
                    children: [
