...
function Master() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLayout, {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: cards.map((c) =>
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            ...
            {
              className:
                "text-left bg-card border rounded-xl p-4 hover:border-primary transition-colors",
              children: [
                ...
                c.key === "item" &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                    ...
                    className:
                      "mt-3 w-full h-8 px-2 border rounded text-xs bg-background focus:outline-none focus:ring-1 focus:ring-primary",
                    children: [
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
                            ...
                            import_jsx_runtime.jsx)("span", {
                              className:
                                "text-[10px] px-1.5 py-0.5 bg-success/15 text-success rounded",
                              children: "Active",
                            }),
                          }),
                        ],
      ...
      panelOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PanelMasterModal, {
          onClose: () => setPanelOpen(false),
        }),
      (itemFormOpen === "lab" || itemFormOpen === "radiology") &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ManageInvestigationsModal, {
          kind: itemFormOpen,
          onClose: () => {
      ...
      itemFormOpen === "medical" &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MedicalItemModal, {
          onClose: () => {
            setItemFormOpen(null);
            setItemType("");
          },
      ...
      itemFormOpen === "others" &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OthersItemMasterModal, {
          onClose: () => {
            setItemFormOpen(null);
            setItemType("");
          },
      ...
      globalOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GlobalMasterModal, {
...
function PanelMasterModal({ onClose }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    className:
      "fixed inset-0 z-50 bg-black/50 flex items-start justify-center overflow-y-auto p-4",
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className: "bg-card rounded-lg shadow-xl w-full max-w-6xl my-4",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "flex items-center justify-between px-4 py-2.5 border-b bg-muted/50",
          children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 pt-3 border-t mt-2",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className: "text-sm",
                  children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "md:col-span-3 flex justify-center gap-3 pt-4 border-t mt-2",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  type: "submit",
                  className:
                    "px-8 py-2 bg-primary text-primary-foreground rounded font-semibold hover:bg-primary/90",
                  children: "Save",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                  type: "button",
                  onClick: onClose,
                  className:
                    "px-6 py-2 border rounded font-semibold hover:bg-muted",
                  children: "Cancel",
                }),
              ],
            }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "flex items-center justify-between px-4 py-2.5 border-b bg-primary/10",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                  className:
                    "text-xs h-72 overflow-y-auto border rounded p-2 space-y-1 bg-background",
                  children: list.map((n) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "li",
                      {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
              className:
                "border rounded p-4 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3",
              onSubmit: (e) => {
                e.preventDefault();
                onClose();
              },
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "select",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
                          children: "Path Numeric",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
                          children: "Path Descriptive",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
                          children: "Radiology",
                        }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "md:col-span-2 flex justify-center gap-3 pt-3 border-t mt-1",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      type: "submit",
                      className:
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-3 pb-3 border-b",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
                  label: "Category",
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex justify-center gap-6 text-sm text-primary underline",
              children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  className: "text-xs text-muted-foreground",
                  children:
                    "Manage all dropdown lists used across the application from a single screen",
                }),
              ],
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
          ...
          children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "text-[10px] uppercase tracking-wide text-muted-foreground px-2 py-1 font-semibold",
                        children: g.group,
                      }),
                      g.items.map((i) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "px-4 py-3 border-b flex flex-wrap items-center gap-2",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      value: newVal,
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      onClick: add,
                      className:
                        "h-8 px-4 bg-primary text-primary-foreground rounded text-sm font-semibold hover:bg-primary/90",
                      children: "+ Add",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      value: search,
                                    ...
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      "td",
                                      {
                                        ...
                                        import_jsx_runtime.jsx)("input", {
                                          value: v,
                                          onChange: (e) =>
                                            edit(realIdx, e.target.value),
                                          className:
                                            "w-full h-8 px-2 border rounded bg-background focus:outline-none focus:ring-1 focus:ring-primary",
                                        }),
                                      },
                                    ),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      "td",
                                      {
                                        ...
                                        import_jsx_runtime.jsx)("button", {
                                          ...
                                          className:
                                            "text-xs px-2 py-1 border border-destructive/30 text-destructive rounded hover:bg-destructive/10",
                                          children: "Delete",
                                        }),
                                      },
                                    ),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "border-t px-4 py-3 flex justify-end gap-2 bg-muted/30",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      onClick: onClose,
                      className:
                        "px-4 py-1.5 border rounded text-sm hover:bg-muted",
                      children: "Cancel",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      onClick: onClose,
                      className:
                        "px-6 py-1.5 bg-primary text-primary-foreground rounded text-sm font-semibold hover:bg-primary/90",
