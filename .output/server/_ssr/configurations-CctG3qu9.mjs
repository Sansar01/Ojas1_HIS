          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                ...
                children:
                  "Select a module to open — only that page will appear in the sidebar",
              }),
            ],
          }),
        ...
        children: modules.map((m) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              ...
              className:
                "group text-left bg-card border rounded-xl p-5 hover:border-primary hover:shadow-md transition-all",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "text-xs font-medium text-primary mt-3 opacity-0 group-hover:opacity-100 transition-opacity",
