...
//#region node_modules/.nitro/vite/services/ssr/assets/teleconsultation-DRFF3ozT.js
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              ...
                              {
                                className:
                                  "font-mono px-1.5 py-0.5 bg-muted rounded",
                                children: q.id,
                              },
                            ),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "p-3 border-b bg-muted/30 flex items-center gap-3",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-sm font-bold text-primary",
                        children: "AR",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className: "flex-1",
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "text-xs text-muted-foreground",
                            children:
                              "34Y Female · O+ · Star Health · Fever, throat pain",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "text-[10px] px-2 py-1 rounded bg-destructive/10 text-destructive",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "relative bg-gradient-to-br from-slate-900 to-slate-800 aspect-video flex items-center justify-center",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "w-24 h-24 rounded-full bg-white/10 mx-auto flex items-center justify-center text-3xl font-bold mb-3",
                            children: "AR",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "absolute bottom-4 right-4 w-40 aspect-video rounded-lg bg-slate-700 border-2 border-white/20 flex items-center justify-center text-white/70 text-xs",
                        children: video
                          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              import_jsx_runtime.Fragment,
                              { children: "👨‍⚕️ Dr. Arjun (You)" },
                            )
                          : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              VideoOff,
                              { className: "w-6 h-6" },
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            className:
                              "px-2 py-1 rounded bg-destructive text-destructive-foreground text-[10px] font-semibold flex items-center gap-1",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "span",
                                {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "px-2 py-1 rounded bg-black/40 text-white text-[10px]",
                            children: "04:22",
                          }),
                        ],
                      }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "p-4 flex items-center justify-center gap-3 bg-card",
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        className:
                          "w-11 h-11 rounded-full bg-muted flex items-center justify-center",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        className:
                          "w-14 h-11 rounded-full bg-destructive text-destructive-foreground flex items-center justify-center gap-1 text-xs font-medium px-3",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            PhoneOff,
                            { className: "w-4 h-4" },
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "textarea",
                                    {
                                      ...
                                      defaultValue:
                                        "Fever 101°F since yesterday, sore throat, mild body ache.",
                                    },
                                  ),
                                ],
                              },
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "textarea",
                                    {
                                      ...
                                      className:
                                        "w-full mt-1 p-2 border rounded-lg text-sm",
                                      defaultValue:
                                        "Acute pharyngitis, likely viral. Advise symptomatic management.",
                                    },
                                  ),
                                ],
                              },
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    "div",
                                    {
                                      ...
                                      children: [
                                        /* @__PURE__ */ (0,
                                        import_jsx_runtime.jsxs)("select", {
                                          className:
                                            "flex-1 p-2 border rounded-lg text-sm",
                                          children: [
                                            /* @__PURE__ */ (0,
                                            import_jsx_runtime.jsx)("option", {
                                              children:
                                                "In-person after 3 days",
                                            }),
                                            /* @__PURE__ */ (0,
                                            import_jsx_runtime.jsx)("option", {
                                              children: "Video after 5 days",
                                            }),
                                          ],
                                        }),
                                        /* @__PURE__ */ (0,
                          ...
                          children: [
                            [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                ...
                                {
                                  className:
                                    "p-3 border rounded-lg flex justify-between",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      "span",
                                      { children: t },
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "p-3 rounded-lg bg-info/10 border border-info/20 text-xs mt-2",
                              children:
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mt-3 p-2 rounded-lg bg-success/10 text-success text-xs flex items-center gap-2",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mt-3 flex items-center gap-2 border rounded-lg px-2 py-1",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        className: "p-1",
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                        ...
                        className:
                          "flex-1 py-1.5 text-sm focus:outline-none bg-transparent",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        className:
                          "p-1.5 bg-primary text-primary-foreground rounded",
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          Send,
