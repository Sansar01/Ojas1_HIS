...
import {
  a as logOutFromFrontend,
  i as getUser,
  n as api,
  r as canAccess,
} from "./auth-Bp511B8q.mjs";
import {
  i as require_react,
...
import {
  ...
  bt as Activity,
  c as Users,
  ct as CircleDollarSign,
  d as UserCog,
  gt as BriefcaseMedical,
  ht as Calendar,
  o as Video,
  ot as ClipboardList,
  pt as ChartColumn,
...
//#region node_modules/.nitro/vite/services/ssr/assets/AppLayout-Ch-U9iwL.js
...
function useDepartments() {
  ...
  (0, import_react.useEffect)(() => {
    api
      .get("/api/hospital/masters/departments", { params: { active: true } })
      .then(setDepartments)
      .catch((e) => setError(e.message))
      .finally(() => setLoading(false));
  }, []);
...
function useShifts() {
  ...
  (0, import_react.useEffect)(() => {
    api
      .get("/api/hospital/masters/shifts", { params: { active: true } })
      .then(setShifts)
      .catch((e) => setError(e.message))
      .finally(() => setLoading(false));
  }, []);
...
function useEntitlements() {
  ...
  (0, import_react.useEffect)(() => {
    api
      .get("/api/hospital/roles/entitlements/modules")
      .then((data) => {
...
function useRolePermissions(roleId) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    setError(null);
    api
      .get(`/api/hospital/roles/${roleId}/permissions`)
      .then(setPermissions)
      .catch((e) => setError(e.message))
      .finally(() => setLoading(false));
  }, [roleId]);
...
function useHospitalUsers() {
  ...
  (0, import_react.useEffect)(() => {
    api
      .get("/api/hospital/users", { params: { status: "ACTIVE" } })
      .then((data) => {
        if (!Array.isArray(data)) {
          setUsers([]);
          return;
...
function useCreateUser() {
  ...
  return {
    createUser: (0, import_react.useCallback)(async (payload) => {
      ...
      setError(null);
      try {
        return await api.post("/api/hospital/users", {
          method: "POST",
          headers: {
...
function AppLayout({ children }) {
  ...
  const onLogout = async () => {
    if (!(await logOutFromFrontend())) return;
    navigate({ to: "/login" });
  };
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
        className:
          "w-64 shrink-0 bg-sidebar text-sidebar-foreground flex flex-col",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "p-5 flex items-center gap-3 border-b border-sidebar-border",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, {
                  className: "w-5 h-5 text-primary-foreground fill-primary",
                }),
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "text-[10px] uppercase tracking-wider text-sidebar-foreground/50 px-3 py-2",
                children: entitlementsLoading
                  ? "Loading modules..."
                  : "Navigation",
              }),
              visibleNav.length > 0
                ...
                : !entitlementsLoading
                  ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "text-[11px] text-sidebar-foreground/60 px-3 py-4 text-center",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "w-9 h-9 rounded-full bg-primary/30 flex items-center justify-center text-xs font-semibold",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
            className:
              "h-16 bg-card border-b flex items-center px-6 gap-4 sticky top-0 z-10",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    ...
                    className:
                      "w-full pl-9 pr-16 py-2 rounded-lg bg-muted border border-transparent focus:border-primary focus:outline-none text-sm",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("kbd", {
                    className:
                      "absolute right-3 top-1/2 -translate-y-1/2 text-[10px] px-1.5 py-0.5 rounded bg-background border",
                    children: "Ctrl+K",
                  }),
                ],
              }),
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "absolute top-1 right-1 w-4 h-4 bg-destructive text-destructive-foreground text-[9px] rounded-full flex items-center justify-center",
                        children: "12",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center text-xs font-semibold text-primary",
                        children: user.initials,
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className: "text-xs",
...
//#endregion
export {
  useHospitalUsers as a,
  useShifts as c,
  useEntitlements as i,
  useCreateUser as n,
  useRolePermissions as o,
  useDepartments as r,
  useRoles as s,
  AppLayout as t,
};
