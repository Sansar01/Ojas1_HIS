...
import {
  a as useHospitalUsers,
  c as useShifts,
  i as useEntitlements,
  n as useCreateUser,
  o as useRolePermissions,
  r as useDepartments,
  s as useRoles,
  t as AppLayout,
} from "./AppLayout-Ch-U9iwL.mjs";
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              onClick: copyAll,
              className:
                "flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border rounded-lg text-sm font-medium",
              children: [
                copied
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              onClick: onClose,
              className:
                "flex-1 px-4 py-2.5 bg-primary text-primary-foreground rounded-lg text-sm font-medium",
              children: "Done",
            }),
          ],
        }),
...
function UserManagement() {
  ...
  const [selectedPermissions, setSelectedPermissions] = (0,
      ...
      const payload = {
        ...
        roles: {
          primaryRoleId: formData.primaryRoleId
            ? Number(formData.primaryRoleId)
            : void 0,
          additionalRoleIds:
            formData.additionalRoleIds.length > 0
              ? formData.additionalRoleIds.map((id) => Number(id))
              : void 0,
        },
        departmentIds:
          formData.departmentIds.length > 0
            ? formData.departmentIds.map((id) => Number(id))
            : void 0,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLayout, {
    children: [
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                ...
                children: [
                  ...
                  i < steps.length - 1 &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: `flex-1 h-0.5 mx-3 ${done ? "bg-success" : "bg-border"}`,
                    }),
                ],
              },
              s.n,
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    ...
                    {
                      className:
                        "w-full px-2 py-2 border rounded-lg text-sm bg-muted cursor-not-allowed",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(F, {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                      ...
                      disabled: lockedType,
                      className:
                        "w-full px-2 py-2 border rounded-lg text-sm disabled:opacity-70 disabled:cursor-not-allowed",
                      children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                  ...
                  children: deptsLoading
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "px-2 py-2 text-sm text-muted-foreground border rounded-lg",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                  ...
                  children: rolesLoading
                    ...
                    : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
                        ...
                        onChange: (e) =>
                          updateField("primaryRoleId", e.target.value),
                        className: "w-full px-2 py-2 border rounded-lg text-sm",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "option",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                  ...
                  children: rolesLoading
                    ...
                    : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "grid grid-cols-2 md:grid-cols-4 gap-2 p-2 border rounded-lg min-h-12",
                        children: [
                          activeRoles
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                      "input",
                                      {
                                        ...
                                        className: "rounded",
                                        checked:
                                          formData.additionalRoleIds.includes(
                                            r.id,
                                          ),
                                        onChange: () => {
                                          const ids =
                          ...
                          activeRoles.filter(
                            (r) => r.id !== formData.primaryRoleId,
                          ).length === 0 &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "text-xs text-muted-foreground col-span-4",
                              children: formData.primaryRoleId
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "grid grid-cols-12 gap-2 text-[11px] font-medium text-muted-foreground px-2",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      ...
                      days.map((d) => {
                        ...
                        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          ...
                          {
                            className:
                              "grid grid-cols-12 gap-2 items-center bg-card border rounded-lg p-2",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "div",
                                {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "div",
                                {
                                  ...
                                  import_jsx_runtime.jsx)("input", {
                                    ...
                                    className:
                                      "w-full px-2 py-1.5 border rounded text-sm disabled:opacity-50",
                                  }),
                                },
                              ),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                ...
                                {
                                  className:
                                    "col-span-1 text-right text-xs text-muted-foreground",
                                  children: hrs,
                                },
                              ),
                            ],
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          ...
                          {
                            className:
                              "w-full px-2 py-2 border rounded-lg text-sm",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
          ...
          children: [
            ...
            formData.primaryRoleId &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mb-4 flex items-center gap-2 p-3 bg-primary/5 border border-primary/20 rounded-lg text-xs text-primary",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
            ...
            errors.permissions &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "mb-4 p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-sm text-destructive",
                      ...
                      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                              className:
                                "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 px-4 pb-3",
                              children: module.features.map((feature) => {
                                const isOn =
                                  !!selectedPermissions[
                                    `${module.id}__${feature.id}`
                                  ];
                                return /* @__PURE__ */ (0,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "input",
                      {
                        ...
                        className: "w-full px-2 py-2 border rounded-lg text-sm",
                        placeholder:
                          "Min 8 chars (leave empty for auto-generated)",
                      },
                    ),
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(F, {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "select",
                      {
                        ...
                        onChange: (e) =>
                          updateField("loginType", e.target.value),
                        className: "w-full px-2 py-2 border rounded-lg text-sm",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "option",
                  ...
                  submitError &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "flex items-start gap-2 p-3 bg-destructive/10 border border-destructive/20 rounded-lg text-sm text-destructive",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          CircleAlert,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "p-3 bg-muted rounded-lg text-xs space-y-1.5 border",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
              ...
              action: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, {
              ...
              children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
                          className:
                            "w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 text-muted-foreground",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                          value: userSearch,
                          ...
                          className:
                            "w-full pl-8 pr-2 py-2 border rounded-lg text-sm",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className:
                        "mt-2 max-h-56 overflow-y-auto border rounded-lg divide-y",
                      children: usersLoading
                        ...
                        : existingUsers
                            ...
                            .map((u) => {
                              ...
                              const primaryRole = u.roles.find(
                                (r) => r.isPrimary,
                              );
                              return /* @__PURE__ */ (0,
                              import_jsx_runtime.jsxs)(
                  ...
                  children: [
                    ...
                    deptsLoading
                      ...
                      : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
                          ...
                          className:
                            "w-full px-2 py-2 border rounded-lg text-sm mt-1 h-36",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "p-3 rounded-lg bg-warning/10 border border-warning/30 text-xs",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: "font-semibold mb-1",
                      children: "⚠ Note",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                  ...
                  className:
                    "mt-4 w-full px-4 py-2 rounded-lg border border-primary text-primary text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, {
                      className: "w-4 h-4",
                    }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mt-6 flex items-center justify-between bg-card border rounded-xl p-4",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            onClick: () => setStep(Math.max(1, step - 1)),
            disabled: step === 1,
            className:
              "px-4 py-2 rounded-lg border text-sm disabled:opacity-40",
            children: "← Previous",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className: "text-xs text-muted-foreground",
            children: ["Step ", step, " of ", steps.length],
          }),
          step < steps.length
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                onClick: handleNext,
                className:
                  "px-4 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium cursor-pointer",
                children: "Next →",
              })
            : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                ...
                disabled: submitting,
                className:
                  "px-4 py-2 rounded-lg bg-success cursor-pointer text-white text-sm font-medium disabled:opacity-50",
                children: submitting
                  ? "Creating..."
                  : "✓ Register User & Save Rights",
              }),
        ],
      }),
    ],
