...
//#region node_modules/.nitro/vite/services/ssr/assets/user-management-users-kX0RwVsE.js
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "mb-4 flex items-center gap-2 rounded-lg border bg-muted/30 px-3 py-2 text-sm",
            children: [
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                    "div",
                                    {
                                      ...
                                      children: /* @__PURE__ */ (0,
                                      import_jsx_runtime.jsx)(UserCog, {
                                        className: "h-5 w-5",
                                      }),
                                    },
                                  ),
