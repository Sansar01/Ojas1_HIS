...
import { A as Pill, Z as FlaskConical, _ as Stethoscope, at as Clock, bt as Activity, c as Users, f as UserCheck, ht as Calendar, lt as CircleCheck, m as TrendingUp, p as TriangleAlert, vt as ArrowRight } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-JcoGx8K_.js
var import_jsx_runtime = require_jsx_runtime();
function Dashboard() {
	const { data, isLoading, error } = useApiQuery(["dashboard-overview"], "/dashboard/overview", { staleTime: 3e4 });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppLayout, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "px-3 py-2 rounded-lg bg-card border flex items-center gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-success animate-pulse" }), " Live"]
				})]
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kpi, {
					icon: TrendingUp,
					label: "Revenue",
					value: isLoading ? "—" : `₹${(overview?.revenue ?? 84e4).toLocaleString()}`,
					delta: "15%",
					tone: "primary"
				})
			]
		...
		error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: "Unable to load dashboard metrics. Showing cached fallback values."
		}) : null,
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					}), i < arr.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-4 h-4 text-muted-foreground" })]
				}, s.l))
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(a.i, { className: `w-4 h-4 mt-0.5 ${a.tone}` }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Count" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
					...
					].map(([s, c, r]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
