...
import { a as useHospitalUsers, c as useShifts, i as useEntitlements, n as useCreateUser, o as useRolePermissions, r as useDepartments, s as useRoles, t as AppLayout } from "./AppLayout-TYH-YrXk.mjs";
import { n as Section } from "./Kpi-DY4t6Vll.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/user-management-BDznw0T7.js
...
function UserManagement() {
	...
	const updateField = (field, value) => setFormData((prev) => ({
		...prev,
		[field]: value
	}));
		...
		try {
			const payload = {
				...
				roles: {
					...
					additionalRoleIds: formData.additionalRoleIds.length > 0 ? formData.additionalRoleIds : void 0
				},
				departmentIds: formData.departmentIds.length > 0 ? formData.departmentIds : void 0,
