...
//#region node_modules/.nitro/vite/services/ssr/assets/change-password-DKZHuZL_.js
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "w-14 h-14 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4",
            ...
            user?.email &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mt-2 text-xs text-muted-foreground bg-muted-foreground/10 rounded-lg px-3 py-1.5 inline-block",
                children: [
                  "Logged in as ",
            ...
            : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
                ...
                children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                            ...
                            required: true,
                            className:
                              "w-full px-3 py-2.5 pr-10 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/30",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                            {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    ...
                    className:
                      "w-full py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed mt-2",
                    children: loading
                      ? "Changing Password..."
                      : "Set New Password",
                  }),
