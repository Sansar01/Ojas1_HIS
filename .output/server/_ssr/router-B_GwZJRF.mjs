...
function RootComponent() {
  ...
  if (isCheckingAuth)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      className:
        "flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.12),transparent_55%)] px-4",
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "w-full max-w-sm rounded-2xl border border-border/70 bg-card p-8 text-center shadow-sm",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "h-7 w-7 animate-spin rounded-full border-3 border-primary border-t-transparent",
            }),
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
var $$splitComponentImporter$13 = () =>
  import("./change-password-DKZHuZL_.mjs");
...
var $$splitComponentImporter$2 = () =>
  import("./teleconsultation-DRFF3ozT.mjs");
...
var $$splitComponentImporter = () =>
  import("./user-management-users-kX0RwVsE.mjs");
