    ...
    <AppLayout>
      <div className="mb-6 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">View all users created through the user management flow.</p>
        </div>
        <Link to="/user-management" className="inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-sm">
      ...
      <Section title="User List">
        <div className="mb-4 flex items-center gap-2 rounded-lg border bg-muted/30 px-3 py-2 text-sm">
          ...
          <span className="text-muted-foreground">Showing created users from the hospital directory</span>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-lg border border-dashed p-6 text-center text-sm text-muted-foreground">No users created yet.</div>
        ) : (
