...
function Registration() {
  const [visitType, setVisitType] = useState<"new" | "revisit" | "emergency">(
    "new",
  );
  const [payType, setPayType] = useState<"self" | "insurance" | "corporate">(
    "self",
  );
        ...
        <Section title="New Patient Registration" className="lg:col-span-3">
          ...
          <div className="grid grid-cols-4 gap-4 mb-5">
            ...
            <div className="col-span-3 grid grid-cols-3 gap-3">
              ...
              <Field label="Alt Mobile">
                <input className="w-full px-2 py-2 border rounded-lg text-sm" />
              </Field>
              <Field label="Email">
                <input
                  className="w-full px-2 py-2 border rounded-lg text-sm"
          ...
          <div className="grid grid-cols-2 gap-6 mb-5">
            ...
            <div>
              ...
              <div className="mt-4 text-sm font-semibold mb-2">
                Emergency Contact
              </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t">
            <label className="flex items-center gap-2 text-xs text-muted-foreground">
              <input type="checkbox" className="rounded" defaultChecked /> Send
              SMS / WhatsApp with UHID & token
            </label>
            <div className="flex gap-2">
              <button className="px-4 py-2 rounded-lg border text-sm">
                Clear
