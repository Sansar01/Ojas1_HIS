...
function Examination() {
  const [tab, setTab] = useState<
    "waiting" | "vitalsDone" | "readyForDoctor" | "consultation"
  >("waiting");
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-4 gap-4 text-xs mt-2">
                  <div>
                    ...
                    <div className="font-semibold">58Y, Male</div>
                  </div>
                  <div>
                  ...
                  <div>
                    <div className="text-muted-foreground">ABDM ID</div>
                    <div className="font-semibold">XJHGF2345K</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3 mb-4">
              {vitals.map((v) => (
                <div key={v.l} className="p-3 border rounded-lg">
                  ...
                  <div className={`text-lg font-bold ${v.tone ?? ""}`}>
                    {v.v}
                  </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="text-xs mt-2">
                    <span className="text-muted-foreground">Dx:</span> {v.dx}
                  </div>
                  <div className="text-xs">
                    <span className="text-muted-foreground">Rx:</span> {v.rx}
                  </div>
