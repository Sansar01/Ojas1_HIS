    ...
    <AppLayout>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Live video consultation with patient
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 space-y-6">
          <div className="bg-card border rounded-xl overflow-hidden">
            ...
            <div className="p-3 border-b bg-muted/30 flex items-center gap-3">
              ...
              <span className="text-[10px] px-2 py-1 rounded bg-destructive/10 text-destructive">
                Allergy: Sulpha
              </span>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 aspect-video flex items-center justify-center">
              <div className="text-center text-white/90">
                <div className="w-24 h-24 rounded-full bg-white/10 mx-auto flex items-center justify-center text-3xl font-bold mb-3">
                  AR
                </div>
                <div className="font-semibold">Anita Roy</div>
                <div className="text-xs text-white/60 mt-1">
                  📹 Video connected · 720p HD
                </div>
              </div>
              ...
              <div className="absolute top-4 left-4 flex gap-2">
                ...
                <span className="px-2 py-1 rounded bg-black/40 text-white text-[10px]">
                  04:22
                </span>
              </div>
            </div>
            ...
            <div className="p-4 flex items-center justify-center gap-3 bg-card">
              ...
              <button className="w-11 h-11 rounded-full bg-muted flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-1">
                      <select className="flex-1 p-2 border rounded-lg text-sm">
                        <option>In-person after 3 days</option>
                        <option>Video after 5 days</option>
                      </select>
                      <input
                        type="date"
              ...
              {tab === "invest" && (
                <div className="space-y-2 text-sm">
                  ...
                  <div className="p-3 rounded-lg bg-info/10 border border-info/20 text-xs mt-2">
                    Home sample collection available — patient will be notified
                    via SMS.
                  </div>
                </div>
              )}
        ...
        <div className="lg:col-span-3 space-y-6">
          <Section title="Doctor On Call">
            ...
            <div className="grid grid-cols-2 gap-2 mt-4 text-xs">
              ...
              <div className="p-2 border rounded-lg">
                ...
                <div className="font-semibold">EN, HI, MR</div>
              </div>
              <div className="p-2 border rounded-lg">
          ...
          <Section
            title="In-Call Chat"
            action={<MessageSquare className="w-4 h-4 text-muted-foreground" />}
          >
            ...
            <div className="mt-3 flex items-center gap-2 border rounded-lg px-2 py-1">
              ...
              />
              <button className="p-1.5 bg-primary text-primary-foreground rounded">
