  ...
  return (
    <>
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Complete OPD consultation and prescription
          </p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        <Section title="🩺 Chief Complaints & History">
          ...
          <div className="mt-4 text-sm space-y-2">
            ...
            <div className="text-xs">
              Diabetes Mellitus Type 2 since 3 years
            </div>
          </div>
          <div className="mt-4 text-sm space-y-2">
        ...
        <Section
          title="💊 Prescription"
          action={<button className="text-xs text-primary">+ Favorites</button>}
        >
          <input
        ...
        <Section title="🧪 Investigations & Advice">
          ...
          <div className="space-y-1 text-sm">
            {["CBC (Complete Blood Count)", "Lipid Profile", "ECG", "TMT"].map(
              (t) => (
                <div key={t} className="px-3 py-2 border rounded-lg">
                  {t}
                </div>
              ),
            )}
            <button className="w-full py-2 border-2 border-dashed rounded-lg text-sm text-primary mt-1">
              + Add Test
            </button>
          </div>
          <div className="mt-5">
